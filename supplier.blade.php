            ...
            <form action="{{ action('SupplierController@store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="addkdsupp" id="addkdsup" class="form-control" maxlegth="5" id="exampleFormControlInput1">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Nama Supplier</label>
                        <input type="text" name="addnmsupp" id="addnmsup" class="form-control" id="exampleFormControlInput1">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="addtlpn" id="addtelepon" class="form-control" id="exampleFormControlInput1">
                    </div>
                </div>
